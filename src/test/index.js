...
class Example extends Component {
  ...
  render() {
    const innerContent = this.props.render(this.state.inner, (inner) => this.setState({ inner }))
    return (
      <View>
        {innerContent}
      </View>
...
export default class Index extends Component {
  ...
  @autoBind
  reload() {
    console.log(`reload btn and current  state cotent length=${this.state.content.length}`)
  }
